...
namespace Minutas2
{
    public partial class Form2 : Form
    {
        public Form2()
        {
            ...
            cmbnotario_encargado.Items.Add("JORGE MANRIQUE ANDRADE");
            cmbnotario_encargado.Items.Add("CLAUDIA MARCELA GRANADA");
            cmbnotario_encargado.Items.Add("MARCELA PATIÑO PEÑA");
        ...
        private void button1_Click(object sender, EventArgs e) //boton Validar
        {
            ...
            double cedula_poderdante = double.Parse(txt_ced_poderdante.Text);
            double num_escritura = double.Parse(txtnumescritura.Text);
            string ciud_exp_poderdante = txt_ciud_poderdante.Text.ToUpper();
            string nombre_apoderado = txtnombre_apoderado.Text.ToUpper();
            double cedula_apoderado = double.Parse (txtced_apoderado.Text);
            string ciud_expd_apoderado = txtciud_apoderado.Text.ToUpper();
            string estado_civil = txtestado_civil.Text.ToUpper();
            double recuado = double.Parse(txtrecaudo.Text);
            double derechos = double.Parse(txtderechos.Text);
